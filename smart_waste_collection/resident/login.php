...
<head>
    ...
    <title>Resident Login - Waste Collection Management System</title>
...
<body class="bg-light">
                ...
                <div class="card card-custom p-4 shadow-sm border-0">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <h2 class="text-center text-success fw-bold mb-1">Resident Portal</h2>
                            <p class="text-muted small mb-0">Sign in to request waste pickups & pay bills online</p>
                        ...
                        <form id="residentLoginForm">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control border-start-0 ps-0" id="email" required value="maryan@waste.com" placeholder="maryan@waste.com">
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-4 text-end">
                                <a href="forgot_password.html" class="text-success text-decoration-none small"><i class="fas fa-key me-1"></i>Forgot Password?</a>
                            </div>
                        ...
                        <div class="text-center mt-4 pt-2 border-top">
                            <p class="text-muted small mb-2">Don't have a resident account? <a href="register.html" class="text-success fw-bold text-decoration-none">Register here</a></p>
    ...
    <script>
        document.getElementById('residentLoginForm').addEventListener('submit', async (e) => {
            ...
            try {
                const res = await apiCall('/auth.php?action=login', 'POST', { email, password, type: 'resident' });
