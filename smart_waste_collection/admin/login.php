...
<head>
    ...
    <title>Admin Login - Waste Collection Management System</title>
...
<body class="bg-light">
                ...
                <div class="card card-custom p-4 shadow-sm border-0">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <h2 class="text-center text-success fw-bold mb-1">Admin Portal</h2>
                            <p class="text-muted small mb-0">Sign in to manage system & operations</p>
    ...
    <script>
        document.getElementById('adminLoginForm').addEventListener('submit', async (e) => {
            ...
            try {
                const res = await apiCall('/auth.php?action=login', 'POST', { email, password, type: 'admin' });
